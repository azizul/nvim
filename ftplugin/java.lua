...
if JAVA_DAP_ACTIVE then
	...
	vim.list_extend(
		bundles,
		vim.split( vim.fn.glob( CONFIG_PATH .. "java-debug/com.microsoft.java.debug.plugin/target/com.microsoft.java.debug.plugin-*.jar"), "\n")
	)
end
...
local config = {
	...
	cmd = {
		...
		-- 💀
		"-jar",
		vim.fn.glob(JDTLS_JAR_GLOB_PATH),
		-- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                       ^^^^^^^^^^^^^^
